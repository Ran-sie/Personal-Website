...
const hairtexture = textureloader.load('Shield_Maiden/Hair_Color.png');
const hairnormal = textureloader.load('Shield_Maiden/Hair_Normal.png');

const aclothcolor = textureloader.load('Shield_Maiden/Cloth_Color.png');
const aclothR = textureloader.load('Shield_Maiden/Cloth_Roughness.png');
const aclothM = textureloader.load('Shield_Maiden/Cloth_Metallic.png');
const aclothNormal = textureloader.load('Shield_Maiden/Cloth_Normal.png');

const bclothcolor = textureloader.load('Shield_Maiden/Weapon_Color.png');
const bclothR = textureloader.load('Shield_Maiden/Weapon_Roughness.png');
const bclothM = textureloader.load('Shield_Maiden/Weapon_Metallic.png');
const bclothNormal = textureloader.load('Shield_Maiden/Weapon_Normal.png');

const characterColor = textureloader.load('Shield_Maiden/Character_Color.png');

const detailColor = textureloader.load('Shield_Maiden/Detail_Color.png');
const detailR = textureloader.load('Shield_Maiden/Detail_Roughness.png');
const detailNormal = textureloader.load('Shield_Maiden/Detail_Normal.png');
...
Gloader.load('Shield_Maiden/a.glb', (gltf) => {
    object = gltf.scene;
    ...
    object.position.set(0, 10, 5);
            ...
            object.traverse((child) => {
                if (child.isMesh) {
                    ...
                    } else if (child.name.toLowerCase().includes('sword') || child.name.toLowerCase().includes('shield')) {
                        materialParams = {
                            map: bclothcolor,
