...
const hairtexture = textureloader.load('Sorceress_of _the_Elements/Hair_Color.png');
const hairnormal = textureloader.load('Sorceress_of _the_Elements/Hair_Normal.png');

const aclothcolor = textureloader.load('Sorceress_of _the_Elements/Cloth_Color.png');
const aclothR = textureloader.load('Sorceress_of _the_Elements/Cloth_Roughness.png');
const aclothM = textureloader.load('Sorceress_of _the_Elements/Cloth_Metallic.png');
const aclothNormal = textureloader.load('Sorceress_of _the_Elements/Cloth_Normal.png');

const bclothcolor = textureloader.load('Sorceress_of _the_Elements/Archer_Color.png');
const bclothR = textureloader.load('Sorceress_of _the_Elements/Archer_Roughness.png');
const bclothM = textureloader.load('Sorceress_of _the_Elements/Archer_Metallic.png');
const bclothNormal = textureloader.load('Sorceress_of _the_Elements/Archer_Normal.png');

const characterColor = textureloader.load('Sorceress_of _the_Elements/Character_Color.png');

const detailColor = textureloader.load('Sorceress_of _the_Elements/Detail_Color.png');
const detailR = textureloader.load('Sorceress_of _the_Elements/Detail_Roughness.png');
const detailNormal = textureloader.load('Sorceress_of _the_Elements/Detail_Normal.png');
...
Gloader.load('Sorceress_of _the_Elements/a.glb', (gltf) => {
    object = gltf.scene;
